define(['moment', 'textures'], function (moment, textures) {
    ...
    var drawCommonVenues = function (vis, data) {
        ...
        $('.js-commonVenues-title').html('You both drank at ' +
            (_.size(data) === 1 ? 'this place' : 'these ' + _.size(data) + ' places'));
        ...
        if (!_.isUndefined(firstSd)) {
            ...
            E.setTooltipText(getTooltipText(data[firstSd]),
                'commonVenues', dim.w,
                (dim.w / 2 - 24 - $('.js-venues-common-name-' + firstSd).width()), barH * firstSd);
        }
    };
